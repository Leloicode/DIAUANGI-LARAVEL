...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 19, 2022 lúc 03:54 AM
...
INSERT INTO `dish` (`IdDish`, `NameDish`, `Id_restaurant`, `Id_post`, `Image`, `Description`, `Outstand`, `created_at`, `updated_at`) VALUES
(1, 'Cút lộn xào me', 1, NULL, 'cutlonxaome.jfif', '10 trứng ăn rất là ngon và ấm bụng', 1, '2022-12-13 04:57:50', '2022-12-13 04:57:50'),
(2, 'Trứng vịt lọn', 1, NULL, 'trungvitlon.jpg', 'Quá ngon , giá cả phải chăng', 1, '2022-12-13 05:03:29', '2022-12-13 05:03:29'),
(3, 'Bánh tráng trộn', 1, NULL, 'banhtrangtron.jpg', 'Bánh tráng rất giòn, rất là ngon.', 1, '2022-12-13 05:05:59', '2022-12-13 05:05:59'),
(4, 'Khô Mực Mắm', 2, NULL, 'cach-lam-kho-muc-chien-nuoc-mam.png', 'Rất ngon, món nhậu rất tuyệt vời', 1, '2022-12-13 05:10:04', '2022-12-13 05:10:04'),
(5, 'Bò nhúng ớt', 2, NULL, 'bo-nhung-ot-cay-nhung-da-ghie_11630307438.jpg', 'Cay nồng,tạo cho một cuộc chơi chưa tàn', 1, '2022-12-13 05:11:08', '2022-12-13 05:11:08'),
(6, 'Chân gà nước mắm', 2, NULL, 'z2723093738214-d2b8e66eeffebd8-6434-2095-1630633496.jpg', 'Chân gà tươi ngon,thêm chút cay nồng', 1, '2022-12-13 05:12:54', '2022-12-13 05:12:54'),
(7, 'Bánh nậm', 1, NULL, 'bi-quyet-lam-banh-nam-hue-thom-ngon-kho-cuong.jpg', 'Bánh mềm ngon,dể ăn', 1, '2022-12-13 05:13:59', '2022-12-13 05:13:59'),
(8, 'Bánh bèo', 1, NULL, 'mon-banh-beo.jpg', 'Bánh mềm và ấm bụng, rất ngon', 1, '2022-12-13 05:14:51', '2022-12-13 05:14:51'),
(9, 'Bánh tráng cuốn thịt heo', 1, NULL, 'hinh-anh-banh-trang-cuon-thit-heo.jpg', 'Bánh tráng cuốn thịt heo rất ngon', 0, '2022-12-13 05:16:26', '2022-12-13 05:16:26');
...
(3, 'Bún Bò Đá Chẹt', '2A, Củ Chi, Nha Trang', '0357801312', 'bun-dau-nia-thai-nguyen-nha-trang.jpg', 6, 1, '2022-12-13 06:42:22', '2022-12-13 06:42:22'),
...
--
ALTER TABLE `evaluate`
  MODIFY `IdEvaluate` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
ALTER TABLE `dish`
  ...
  ADD CONSTRAINT `dish_ibfk_2` FOREIGN KEY (`Id_restaurant`) REFERENCES `restaurant` (`IdRestaurant`) ON DELETE CASCADE ON UPDATE CASCADE;
